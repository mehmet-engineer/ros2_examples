 ...
 * @date: 07.11.2023
 * @about: executors and callback groups example, publisher and subscriber are not working synchronously.
 **/
...
class SubscriberClass : public rclcpp::Node
{
  ...
  public:
    ...
    void subscriber_callback_1(const std_msgs::msg::String::SharedPtr msg)
    {
      ...
      RCLCPP_INFO(this->get_logger(), "subscriber_callback_1 is running...");
    }
    ...
    { 
      ...
      RCLCPP_INFO(this->get_logger(), "subscriber_callback_2 is running...");
    }
};
